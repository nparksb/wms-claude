...
| Plan | Relationship |
|------|-------------|
| [Reservation Leak Fix](260424-Reservation_Leak_Analysis.md) | Fixed 4 bugs where `.save()` was missing after reservation amount changes — **already deployed** via PR #145 |
