...
| [wms2/plan/](wms2/plan/) | Completed **and superseded** v2 plans (fixes, ports, refactors, performance) | 167 |
| [wms2/analysis/](wms2/analysis/) | Closed v2 investigations | 1 |
| [scripts/](scripts/) | Retired plan verification harnesses (`verify-<plan-id>.sh`) whose plan is archived | 81 |

> Counts refreshed against the filesystem 2026-09-01 (`ls wms*/plan/*.md | wc -l`; `ls wms*/analysis/*.md | wc -l`; `ls scripts/verify-*.sh | wc -l`); they drift as plans are archived — re-run to refresh. Treat Dataview output below as authoritative in Obsidian.
