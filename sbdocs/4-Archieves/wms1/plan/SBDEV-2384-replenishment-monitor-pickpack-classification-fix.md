...
> **Archived 2026-07-14.** Implemented and merged — PR [#169](https://github.com/SiteBossInc/wms-api/pull/169) → `release` (merge commit `b4a2148`, 2026-06-02): migrations `V1.26.29` (flag-based classification) + `V1.26.30` (`ro_id` column). The v2 port shipped separately (PR [#74](https://github.com/SiteBossInc/wms2-api/pull/74) → develop, 2026-07-14). Acceptance script retained at `sbdocs/9-System/scripts/verify-SBDEV-2384-replenishment-monitor-pickpack-classification-fix.sh`.
