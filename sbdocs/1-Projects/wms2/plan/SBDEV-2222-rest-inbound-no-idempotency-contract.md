...
**Files changed:**
- `src/main/resources/db/migration/V1.1.15__add_rest_idempotency.sql` (new)
...
```sql
-- V1.1.15__add_rest_idempotency.sql
...
- Migration `V1.1.15` runs on first wms2-api startup against each tenant DB; ~50ms per tenant; no migration downtime.
